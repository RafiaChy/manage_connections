...
class ChosenAppScreen extends StatefulWidget {
  const ChosenAppScreen({ Key? key }) : super(key: key);

  @override
  _ChosenAppScreenState createState() => _ChosenAppScreenState();
}

class _ChosenAppScreenState extends State<ChosenAppScreen> with TickerProviderStateMixin {
  @override
